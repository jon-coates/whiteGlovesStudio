        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-gray-600 dark:text-gray-400">Email: contact@whiteglovesstudio.com.au</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.services.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-600 dark:text-gray-400 hover:text-yellow-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
